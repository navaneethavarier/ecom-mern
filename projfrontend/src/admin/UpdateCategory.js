...
import { getSingleCategory, updateSingleCategory } from "./helper/adminapicall";
...
const UpdateCategory = ({match}) => {
    ...
    return (
      <form>
        <div className="form-group">
          <p className="lead">Enter the new category name here</p>
          <input
            type="text"
  ...
  return (
    <Base
      ...
      description="You can update your category name here"
